...
class EncoderMeasurementBox():
    ...
    def update_distance_measurement(self):
        ...
        if self.displayed_distance1 != self.encoder.counter_e1:
            self.displayed_distance1 = self.encoder.counter_e1
            self.distance1_label.setText(f"{self.encoder.counter_e1} m")
            
        if self.displayed_distance2 != self.encoder.counter_e2:
            self.displayed_distance2 = self.encoder.counter_e2
